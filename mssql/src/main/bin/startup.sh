...
CANAL_OPTS="-DappName=otter-canal-mssql -Dlogback.configurationFile=$logback_configurationFile"
...
then 
	...
	$JAVA $JAVA_OPTS $JAVA_DEBUG_OPT $CANAL_OPTS -classpath .:$CLASSPATH canal.alibaba.otter.canal.CanalMSSQLClientMain 1>>$base/bin/nohup.out 2>&1 &
